...
public class RecursiveDescentParser implements SysYParser {
    ...
    private Optional<ASTNode> parseFuncDef() {
        ...
        Optional<ASTNode> ret = block.get().deepFind(GrammarType.RETURN, 3);
    ...
    private Optional<ASTNode> parseMainFuncDef() {
        ...
        Optional<ASTNode> retNode = block.get().deepFind(GrammarType.RETURN, 3);
        if (retNode.isEmpty()) {
    ...
    private Optional<ASTNode> parseStmt() {
        ...
        if (preRead4ParseStmt2JudgeLVal()) {
            ...
            if (lVal.isPresent()) {
                ...
                //check if const
                Optional<ASTNode> ident = lVal.get().deepFind(GrammarType.IDENTIFIER, 1);
